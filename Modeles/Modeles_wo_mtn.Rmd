...
```{r}
dataset_2022=dataset_2022[,-c(26:28)]
```
...
clust1=dataset_2022[indice,]  #872 obs
indice<-which(arbre_clust4==2) 
clust2=dataset_2022[indice,] #34 obs
indice<-which(arbre_clust4==3)
clust3=dataset_2022[indice,] #2 obs
indice<-which(arbre_clust4==4)
clust4=dataset_2022[indice,] #11 obs
