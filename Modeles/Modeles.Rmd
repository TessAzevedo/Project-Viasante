...
```{r}
par(mfrow=c(2,2))
hist(clust1$Tps_adh_E_au_L_2022, breaks=15, xlab='Mean subscription time of the companies to the link in year', main='Histogramme')
hist(clust2$Tps_adh_E_au_L_2022, breaks=15, xlab='Mean subscription time of the companies to the link in year', main='Histogramme')
hist(clust3$Tps_adh_E_au_L_2022, breaks=15, xlab='Mean subscription time of the companies to the link in year', main='Histogramme')
hist(clust4$Tps_adh_E_au_L_2022, breaks=15, xlab='Mean subscription time of the companies to the link in year', main='Histogramme')
```


```{r}
clust1$Tps_adh_E_au_L_2022.f=cut(clust1$Tps_adh_E_au_L_2022, include.lowest = FALSE, right = TRUE,
  breaks = c(0,30,50,123))
clust2$Tps_adh_E_au_L_2022.f=cut(clust2$Tps_adh_E_au_L_2022, include.lowest = FALSE, right = TRUE,
  breaks = c(0,30,50,123))
clust3$Tps_adh_E_au_L_2022.f=cut(clust3$Tps_adh_E_au_L_2022, include.lowest = FALSE, right = TRUE,
  breaks = c(0,30,50,123))
clust4$Tps_adh_E_au_L_2022.f=cut(clust4$Tps_adh_E_au_L_2022, include.lowest = FALSE, right = TRUE,
  breaks = c(0,30,50,123))
``` 


```{r}
ggplot(clust1, aes(x="", y=Tps_adh_E_au_L_2022.f, fill=Tps_adh_E_au_L_2022.f)) +
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0)+
    theme_void()
ggplot(clust2, aes(x="", y=Tps_adh_E_au_L_2022.f, fill=Tps_adh_E_au_L_2022.f)) +
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0)+
    theme_void()
ggplot(clust3, aes(x="", y=Tps_adh_E_au_L_2022.f, fill=Tps_adh_E_au_L_2022.f)) +
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0)+
    theme_void()
ggplot(clust4, aes(x="", y=Tps_adh_E_au_L_2022.f, fill=Tps_adh_E_au_L_2022.f)) +
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0)+
    theme_void()
```
...
### montant dep 2022
```{r}
summary(clust1$Mnt_dep_2022)
summary(clust2$Mnt_dep_2022)
summary(clust3$Mnt_dep_2022)
summary(clust4$Mnt_dep_2022)
par(mfrow=c(2,2))
boxplot(clust1$Mnt_dep_2022,ylim=c(0,quantile(clust1$Mnt_dep_2022,0.9)))
boxplot(clust2$Mnt_dep_2022,ylim=c(0,quantile(clust2$Mnt_dep_2022,0.9)))
boxplot(clust3$Mnt_dep_2022,ylim=c(0,quantile(clust3$Mnt_dep_2022,0.9)))
boxplot(clust4$Mnt_dep_2022,ylim=c(0,quantile(clust4$Mnt_dep_2022,0.9)))
```
...
### RAC_2022
```{r}
summary(clust1$RAC_2022)
summary(clust2$RAC_2022)
summary(clust3$RAC_2022)
summary(clust4$RAC_2022)
par(mfrow=c(2,2))
boxplot(clust1$RAC_2022,ylim=c(quantile(clust1$RAC_2022,0.1),quantile(clust1$RAC_2022,0.9)))
boxplot(clust2$RAC_2022,ylim=c(quantile(clust2$RAC_2022,0.1),quantile(clust2$RAC_2022,0.9)))
boxplot(clust3$RAC_2022,ylim=c(quantile(clust3$RAC_2022,0.1),quantile(clust3$RAC_2022,0.9)))
boxplot(clust4$RAC_2022,ylim=c(quantile(clust4$RAC_2022,0.1),quantile(clust4$RAC_2022,0.9)))
```
