...
for (i in 1:1){
  ...
  tab$Max_departement[i]=max_repr(sub_lien,7)
  
  # regroup1 le plus present
  tab$Max_regroup1[i]=max_repr(sub_lien,8)
  
  #regroup4 le plus present
  tab$Max_regroup4[i]=max_repr(sub_lien,9)
