...
```{r}
par(mfrow=c(2,3))
hist(tab_eff$Nb_pers_2018,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de personnes par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_pers_2019,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de personnes par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_pers_2020,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de personnes par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_pers_2021,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de personnes par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_pers_2022,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de personnes par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
``` 
...
```{r}
par(mfrow=c(2,3))
hist(tab_eff$Nb_fam_2018,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de familles par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_fam_2019,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de familles par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_fam_2020,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de familles par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_fam_2021,breaks=c(0,2000,5000,10000,12000), xlab='Nombre de familles par lien', ylab='Effectif', main='Histogramme')
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
hist(tab_eff$Nb_fam_2022,breaks=10000, xlab='Nombre de familles par lien', ylab='Effectif', main='Histogramme',xlim=c(0,quantile(tab_eff$Nb_fam_2022)))
abline(v=c(0,2000,5000,10000,12000),col="red", lwd=3)
``` 
