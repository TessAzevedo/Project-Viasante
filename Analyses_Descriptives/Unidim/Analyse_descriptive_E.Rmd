...
```
```{r}
hist(tab_eff$Tps_adh_moy_pers_ds_L, breaks=c( 0,10,20,50, max(tab_eff$Tps_adh_moy_pers_ds_L)), xlab='Ancienneté moyenne des personnes dans les liens', main='Histogramme')
abline(v=c(0,10,20,50,max(tab_eff$Tps_adh_moy_pers_ds_L)),col="red", lwd=3)
```
