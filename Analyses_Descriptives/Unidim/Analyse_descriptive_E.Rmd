...
```{r}
boxplot(tab_eff_nb$Actifs_2022)
```


```{r}
hist(tab_eff_nb$Actifs_2022,breaks=10,freq =TRUE, main = "Histogramme",xlab = "Actifs",ylab = "Effectifs")
```
Les entreprises ont en principe soit 10% soit 100% actifs.
### Non actifs

```{r}
boxplot(tab_eff_nb$Non_actifs_2022)
```


```{r}
hist(tab_eff_nb$Non_actifs_2022,breaks =10,freq =TRUE, main = "Histogramme",xlab = "Non actifs",ylab = "effectifs")
...
```{r}
boxplot(tab_eff_nb$Portabilite_2022)
```


```{r}
hist(tab_eff_nb$Portabilite_2022,breaks =5,freq =TRUE, main = "Histogramme",xlab = "Portabilite",ylab = "effectifs")
```
...
```{r}
hist(tab_eff_nb$Asspri_2022,breaks=100,xlab='Assuré principal', ylab='Effectif en pourcentage', main='Histogramme')
``` 
### Conjoint


```{r}
hist(tab_eff_nb$Conjoint_2022,breaks=100,xlab='Conjoint', ylab='Effectif en pourcentage', main='Histogramme')
``` 

### Enfants

```{r}
hist(tab_eff_nb$Enfants_2022,breaks=100,xlab='Enfant', ylab='Effectif en pourcentage', main='Histogramme')
``` 
...
```{r}
load(file="../../Donnees/Effectifs/Effectif_final_freq.Rdata")
```


```{r}
#par(mfrow=c(3,2))
hist(tab_eff_freq$Option_2018,breaks=50,xlab='Option', ylab='Effectif', main='Histogramme')
hist(tab_eff_freq$Option_2019,breaks=50,xlab='Option', ylab='Effectif', main='Histogramme')
hist(tab_eff_freq$Option_2020,breaks=50,xlab='Option', ylab='Effectif', main='Histogramme')
hist(tab_eff_freq$Option_2021,breaks=50,xlab='Option', ylab='Effectif', main='Histogramme')
hist(tab_eff_freq$Option_2022,breaks=50,xlab='Option', ylab='Effectif', main='Histogramme')
``` 
...
```{r}
df1=aggregate(tab_eff_nb$Tps_adh_E_par_L_2022.f,list(tab_eff_nb$Tps_adh_E_par_L_2022.f),length)
...
```{r}
df1=aggregate(tab_eff_nb$Tps_adh_P_par_L_2022.f,list(tab_eff_nb$Tps_adh_P_par_L_2022.f),length)
colnames(df1)[1]=c("Tmps_adh_P_par_L")
df1$percent=paste(as.character(round(df1$x/sum(df1$x)*100,2)),"%")
ggplot(df1, aes(x="", y=x, fill=Tmps_adh_P_par_L)) +
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0)+
    theme_void()+
   ggtitle("Tmps_adh_P_par_L")+
    geom_text(aes(label = percent),
            position = position_stack(vjust = 0.8))
```
...
```{r}
hist(tab_eff_nb$Femmes_2022,breaks=100,xlab='Femmes', ylab='Effectif en pourcentage', main='Histogramme')
``` 
### Hommes

```{r}
hist(tab_eff_nb$Hommes_2022,breaks=100,xlab='Hommes', ylab='Effectif en pourcentage', main='Histogramme')
``` 
...
```{r}
summary(tab_eff_freq$Respo_2018_p)
summary(tab_eff_freq$Respo_2019_p)
summary(tab_eff_freq$Respo_2020_p)
summary(tab_eff_freq$Respo_2021_p)
summary(tab_eff_freq$Respo_2022_p)
```
