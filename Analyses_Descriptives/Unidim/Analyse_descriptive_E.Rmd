...
```{r}
#par(mfrow=c(3,2))
hist(tab_eff_nb$Option_2018,breaks=1000,xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_nb$Option_2019,breaks=1000,xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_nb$Option_2020,breaks=1000,xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_nb$Option_2021,breaks=1000,xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_nb$Option_2022,breaks=1000,xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
``` 
