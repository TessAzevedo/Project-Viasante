...
```{r}
#par(mfrow=c(3,2))
hist(tab_eff_freq$Option_2018,breaks=c(0,25,50,75,100),xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_freq$Option_2019,breaks=c(0,25,50,75,100),xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_freq$Option_2020,breaks=c(0,25,50,75,100),xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_freq$Option_2021,breaks=c(0,25,50,75,100),xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
hist(tab_eff_freq$Option_2022,breaks=c(0,25,50,75,100),xlab='Option', ylab='Effectif en pourcentage', main='Histogramme')
``` 
